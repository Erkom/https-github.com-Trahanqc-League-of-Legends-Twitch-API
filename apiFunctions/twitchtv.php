...
class TwitchTV {
    ...
    var $client_id = "nlcb6mhl5lcp3ox4y00a9iakb7vgysq"; //change this value, should be your TwitchTV Application Client ID
    var $client_secret = "mql4ivj8qnp1ej6oa3dzy3nz8y4f4fg"; //change this value, should be your TwitchTV Application Client Secret
    var $redirect_url = "http://gotme.site-meute.com/api/v1/login"; //change this value, should be your TwitchTV Application Rerdirect URL
